"""
Django settings for qtoken project.
...
WSGI_APPLICATION = 'qtoken.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'qtoken.sqlite3'),
    }
}
